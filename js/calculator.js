...
export const breakData = (text) => {
    try {
        ...
        if (text === "") {
            ...
            const invalidInputRegex = /(ee)|(ππ)|(AA)|(AB)|(AC)|(AD)|(AE)|(AF)|(AX)|(AY)|(BB)|(BC)|(BD)|(BE)|(BF)|(BX)|(BY)|(CC)|(CD)|(CE)|(CF)|(CX)|(CY)|(DD)|(DE)|(DF)|(DX)|(DY)|(EE)|(EF)|(EX)|(EY)|(FF)|(FX)|(FY)|(XX)|(XY)|(YY)/;
...
export const evaluateSpecialMethods = (text) => {
